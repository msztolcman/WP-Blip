...
Proszę o zgłaszanie wszelkich uwag i problemów na tagu [#wpblip](http://blip.pl/tags/wpblip) lub do użytkownika ^[mysz](http://blip.pl/users/mysz/dashboard), ewentualnie można zgłosić ticketa na [GitHub](https://github.com/mysz/WP-Blip/issues).
